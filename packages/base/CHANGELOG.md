...
## [11.0.0]
### Uncategorized
- **BREAKING:** Forbid more undesired syntax ([#207](https://github.com/MetaMask/eslint-config/pull/207))
- **BREAKING:** Enable `id-denylist` and `id-length` rules ([#200](https://github.com/MetaMask/eslint-config/pull/200))
